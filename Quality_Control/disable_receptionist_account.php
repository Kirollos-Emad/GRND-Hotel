...
<html>
    <head>
        <title>Disable Receptionist account</title>
        ...
        <script>
            ...
            function Disable(id)
            {
                let text = "By clicking ok the receptionist account will be Disabled";
                
                if (confirm(text) == true) 
                {
                    jQuery.ajax({
                        url: "includes/func/disable_receptionist_account.php",
                        data: 'id=' + id,
                        type: "POST",
                        success: function(data){
                            location.reload();
    ...
    <body>
        ...
        <h1 style = "border: 6px solid gray; background-color: #f0f0f0; width: 100%; text-align: center;">
            Please click on the image or the name to disable receptionist account 
            </h1>
